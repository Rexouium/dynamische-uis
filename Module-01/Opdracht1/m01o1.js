...
console.log(gewenste_aantal_autos > 80 ? "wel verdiepingen nodig" : "geen verdiepingen nodig")
let Calculate = Math.ceil((gewenste_aantal_autos - 80 )/ 120)

let antwoord = `Om het gewenste aantal autos kwijt te kunnen heb ik ${Calculate} verdiepingen nodig.`;
document.getElementById("antwoord").innerText = antwoord;

console.log(`Om het gewenste aantal autos kwijt te kunnen heb ik ${Calculate} verdiepingen nodig.`)
